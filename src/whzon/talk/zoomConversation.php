...
if ($sessISMOBILE){
  ...
  <body class='pgBody' style='background:#333333;margin:0em;'  >
  <?php
}
else {
...
<iframe FRAMEBORDER="NO" BORDER="NO" scrolling="vertical"  style='background:#333333;' 
height="<?php echo $fH;?>" width="100%"  src="zoomConversationData.php?wzID=<?php echo $sKey?>&fmbrID=<?php echo $mbrID;?>&fchanID=<?php echo $chanID;?>"></iframe>
