...
function changeCountry($countryID,$sKey){
  ...
  exit('{"furl":"/whzon/mytown/myTownProfile.php?wzID='.$sKey.'&myCountryID='.$countryID.'&fscope=myCountry&fwzUserID='.$wzUserID.'"}');
}
function changeProv($provID,$sKey){
  ...
  exit('{"furl":"/whzon/mytown/myTownProfile.php?fsmCID='.$cityID.'&wzID='.$sKey.'&myStateID='.$provID.'&fscope=myState&fwzUserID='.$wzUserID.'"}');
}
...
function changeCity($cityID,$sKey){
  ...
  exit('{"furl":"/whzon/mytown/myTownProfile.php?wzID='.$sKey.'&fscope=myCity&fwzUserID='.$wzUserID.'&myCityID='.$cityID.'"}');
}
?>
